...
def get_parser():
    ...
    parser.add_argument("--data_path", default="./data/WM811K_labeled.pkl", type=str, help="Name of the dataset")
    parser.add_argument("--input_channels", default=1, type=int, help="Number of image channels")
    parser.add_argument("--patch_size", default=8, type=int, help="Name of the dataset")
    ...
    parser.add_argument("--ensemble_type", default="avg", type=str, help="Type of policies aggregetion")
